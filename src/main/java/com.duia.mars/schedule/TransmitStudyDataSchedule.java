...
@Component
@Configurable
public class TransmitStudyDataSchedule implements ISchedule {

    private static final Logger logger = LoggerFactory.getLogger(TransmitStudyDataSchedule.class);
    ...
    @Scheduled(cron = "0 0 1 1 1 ?")    // 每天01:00// todo not execute
    public void schedule() {
        ...
        // 调度记录
        ScheduleRecord record = new ScheduleRecord(Common.ScheduleType.TYPE_TRANSMIT_STUDY_DATA_INDEX, scheduleTime, TransmitStudyDataSchedule.class.getName());
        ...
        try {
            ...
            logger.error("【传输学习数据(每日)调度】发生异常");
