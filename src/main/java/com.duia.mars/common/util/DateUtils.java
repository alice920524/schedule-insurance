...
public class DateUtils {
    ...
    // 格式：年－月－日 00：00：00
    public static final String FORMAT_FOUR_END = "yyyy-MM-dd 23:59:59";
...
//		}
     ...
     * @author xuyl
     */
    public static String formatSort(String strDate, String pattern) {
        Date date = stringtoDate(strDate,LONG_DATE_FORMAT);
        return new SimpleDateFormat(pattern).format(date);
    }
     ...
     * @return
     */
    public static String getFirstDayOfLMonth(String format) {
        Calendar cal = Calendar.getInstance();
        cal.add(Calendar.MONTH, -1);
        cal.set(Calendar.DATE, 1);
        return dateToString(cal.getTime(), format);
     ...
     * @return
     */
    public static String getLastDayOfLMonth(String format) {
        Calendar cal = Calendar.getInstance();
        cal.set(Calendar.DATE, 1);
    ...
    public static Date getLastDayOfLMonth(Date time) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(time);
        cal.set(Calendar.DATE, 1);
        cal.add(Calendar.MONTH, 0);
